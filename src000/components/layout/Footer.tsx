      ...
      <div className="container grid gap-10 py-14 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
        ...
        <div>
          ...
          <div className="mt-5 space-y-3">
            <a className="flex items-center gap-3 text-sm text-slate-300 transition hover:text-white" href="https://wa.me/2348059991118" target="_blank" rel="noreferrer"><MessageCircle size={18} className="text-[#16A34A]" />WhatsApp GNIT</a>
            <a className="flex items-center gap-3 text-sm text-slate-300 transition hover:text-white" href="mailto:info@gnit-ltd.com"><Mail size={18} className="text-[#16A34A]" />info@gnit-ltd.com</a>
            <a className="flex items-center gap-3 text-sm text-slate-300 transition hover:text-white" href="tel:+2348059991118"><Phone size={18} className="text-[#16A34A]" />+234 805 999 1118</a>
          </div>
        </div>
      </div>
